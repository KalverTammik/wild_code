...
TRANSLATIONS = {
        TranslationKeys.LIST_SORT: "Sort",
        TranslationKeys.LIST_GROUP: "Group",
        TranslationKeys.LIST_SORT_DEFAULT: "Default order",
        TranslationKeys.LIST_GROUP_NONE: "No grouping",
        TranslationKeys.LIST_SORT_GLOBAL: "All filtered results",
        TranslationKeys.LIST_SORT_LOCAL: "Loaded items only",
        TranslationKeys.LIST_SORT_TITLE: "Title",
        TranslationKeys.LIST_SORT_DUE: "Due date",
        TranslationKeys.LIST_SORT_START: "Start date",
        TranslationKeys.LIST_SORT_CREATED: "Created",
        TranslationKeys.LIST_SORT_UPDATED: "Updated",
        TranslationKeys.LIST_SORT_STATUS: "Status",
        TranslationKeys.LIST_SORT_TYPE: "Type",
        TranslationKeys.LIST_SORT_PRIORITY: "Priority",
        TranslationKeys.LIST_SORT_RESPONSIBLE: "Responsible person",
        TranslationKeys.LIST_SORT_ASC_TEXT: "A–Z",
        TranslationKeys.LIST_SORT_DESC_TEXT: "Z–A",
        TranslationKeys.LIST_SORT_ASC_DATE: "Earliest first",
        TranslationKeys.LIST_SORT_DESC_DATE: "Latest first",
        TranslationKeys.LIST_SORT_ASC_PRIORITY: "Highest first",
        TranslationKeys.LIST_SORT_DESC_PRIORITY: "Lowest first",
        TranslationKeys.LIST_GROUP_DEADLINE: "Due date status",
        TranslationKeys.LIST_GROUP_SCOPE: "Groups contain loaded items. Counts update as more items load.",
        TranslationKeys.LIST_GROUP_COUNT: "{name} · {count} loaded",
        TranslationKeys.LIST_VALUE_MISSING: "Unspecified",
        TranslationKeys.LIST_DEADLINE_OVERDUE: "Overdue",
        TranslationKeys.LIST_DEADLINE_TODAY: "Today",
        TranslationKeys.LIST_DEADLINE_TOMORROW: "Tomorrow",
        TranslationKeys.LIST_DEADLINE_WEEK: "This week",
        TranslationKeys.LIST_DEADLINE_NEXT_WEEK: "Next week",
        TranslationKeys.LIST_DEADLINE_LATER: "Later",
        TranslationKeys.LIST_DEADLINE_CLOSED: "Closed",
        TranslationKeys.LIST_DEADLINE_NONE: "No due date",
        TranslationKeys.LIST_GROUP_EXPAND_ALL: "Expand all groups",
        TranslationKeys.LIST_GROUP_COLLAPSE_ALL: "Collapse all groups",
        TranslationKeys.LIST_LOCAL_NOTICE: "Sorting: loaded items only",
        TranslationKeys.LIST_GROUP_NOTICE: "Groups: loaded items",
        TranslationKeys.LIST_UNIQUE_COUNT: "{count} unique items loaded",
        TranslationKeys.CARD_LOAD_RETRY: "Try again",
        TranslationKeys.CARD_DETAIL_LOAD_FAILED: "Could not load the details.",
        TranslationKeys.CARD_DETAIL_OPEN: "Show details",
        TranslationKeys.CARD_DETAIL_CLOSE: "Hide details",
        TranslationKeys.CARD_RESPONSIBLE_UNASSIGNED: "Responsible person not assigned",
        TranslationKeys.CARD_MEMBERS_OPEN: "View members",
        TranslationKeys.CARD_MEMBERS_EMPTY: "No members have been added.",
        TranslationKeys.CARD_FILES_VIEW_ALL: "View all files ({count})",
        ...
        TranslationKeys.SETTINGS_MAP_OVERLAY_TITLE: "Map toolbar",
        TranslationKeys.SETTINGS_MAP_OVERLAY_DESCRIPTION: "Show quick action buttons at the edge of the map canvas during the Kavitro session.",
        TranslationKeys.SETTINGS_MAP_OVERLAY_GLASS_BAR: "Show map glass toolbar",
        TranslationKeys.SETTINGS_MAP_OVERLAY_SEARCH_BAR: "Search panel",
        ...
        TranslationKeys.LOCATION_NO_CHOICES: "The import layer has no location choices.",
        TranslationKeys.LOCATION_LOAD_FAILED: "Could not load location data. Try again.",
        TranslationKeys.LOCATION_MAP_FAILED: "Could not update the map view. Try again.",
        TranslationKeys.LOCATION_REFRESH: "Refresh the table and map for the current location choices",
        TranslationKeys.PROPERTY_ADD_RESULT: "Processed {done}/{total}. Succeeded: {succeeded}. Failed: {failed}.",
        TranslationKeys.PROPERTY_IMPORT_CHANGED: "Data changed after review. Inspect the current values and decide again.",
        TranslationKeys.PROPERTY_IMPORT_REVIEW: "Review properties awaiting a decision ({count})",
        TranslationKeys.PROPERTY_IMPORT_REVIEW_TITLE: "Properties awaiting a decision",
        TranslationKeys.PROPERTY_IMPORT_REVIEW_INTRO: "These properties are awaiting a decision. Choose an action for each property; “Leave for later” keeps it in this list until the management window is closed.",
        TranslationKeys.PROPERTY_IMPORT_LATER: "Leave for later",
        TranslationKeys.PROPERTY_IMPORT_KEEP: "Keep existing",
        TranslationKeys.PROPERTY_IMPORT_APPLY: "Apply import data",
        TranslationKeys.PROPERTY_IMPORT_CONFIRM: "Apply selected decisions",
        TranslationKeys.PROPERTY_IMPORT_ACTION: "Action",
        TranslationKeys.PROPERTY_IMPORT_REASON: "Reason",
        TranslationKeys.PROPERTY_IMPORT_DETAILS: "Cadastral number: {tunnus}\n\nImport address: {import_address}\nImport modified: {import_date}\n\nBackend address: {backend_address}\nBackend cadastral data modified: {backend_date}\n\nMain layer address: {main_address}\nMain layer modified: {main_date}",
        TranslationKeys.PROPERTY_IMPORT_WRITE_SCOPE: "“Apply import data” updates the backend immovable number, cadastral data, address, area and intended uses. Existing main layer objects are retained; missing objects are copied from the import layer. “Keep existing” leaves this property unchanged in both the backend and map. Archived and ambiguous matches require separate review.",
        TranslationKeys.PROPERTY_IMPORT_UNKNOWN: "Missing or unknown",
        TranslationKeys.PROPERTY_IMPORT_SUMMARY: "Awaiting a decision: {deferred}. Kept existing: {kept}.",
        TranslationKeys.PROPERTY_IMPORT_MATCHES: "Backend matches: {matches}",
        TranslationKeys.PROPERTY_ADD_BACKEND_DIFFERS: "The backend address differs and the import cannot be confirmed as newer. A decision is needed; data will not be overwritten automatically.",
        TranslationKeys.PROPERTY_ADD_UNFINISHED: "Property processing is unfinished. Check the backend state before adding it again.",
        TranslationKeys.PROPERTY_ADD_STAGE_CANCELLED: "{stage} is unfinished. An earlier step may already be saved; check the property before continuing.",
        TranslationKeys.API_RATE_LIMIT_WAIT: "Server rate limit (HTTP 429). Wait before continuing.",
        TranslationKeys.API_REQUEST_TITLE: "Kavitro request",
        TranslationKeys.PROPERTY_BACKEND_PENDING: "Properties not processed in the backend: {tunnused}",
        TranslationKeys.PROPERTY_DELETE_STOPPED: "Deletion stopped at property {tunnus}: {error}\nFurther properties not processed: {pending}\nThe map layer was not deleted. Earlier backend deletions may be complete; check results before continuing.",
        TranslationKeys.PROPERTY_ARCHIVE_PENDING: "Backend archiving stopped. Map archive copies are retained. Backend actions were not attempted for these properties: {tunnused}",
        TranslationKeys.TASK_FILES_UPLOAD_STOPPED: "File upload stopped. Uploaded: {uploaded}. Saving “{failed}” was not confirmed; check the file list before retrying. Not sent: {pending}.\n{pending_names}",
        TranslationKeys.WORKS_GEOMETRY_SYNC_STOPPED: "Saving geometries to Kavitro stopped at map feature {feature_id}. Further features not processed: {pending}. Map edits are retained, but their backend state needs checking.",
        TranslationKeys.API_REQUEST_RUNNING: "Contacting Kavitro…",
        TranslationKeys.API_REQUEST_RATE_WAIT: "Server rate limit. The same request will retry automatically in {seconds} s.",
        TranslationKeys.API_REQUEST_PACING_WAIT: "Waiting {seconds} s between requests to avoid the server limit. Continuing automatically.",
        TranslationKeys.API_REQUEST_CANCELLED: "The request was cancelled before sending. Earlier operations may be saved; check the result before continuing.",
        TranslationKeys.API_REQUEST_CANCELLING: "Cancelling the wait. Waiting for the response if the request was already sent…",
        ...
        TranslationKeys.PROPERTY_IMPORT_BULK_LABEL: "Set for all:",
        TranslationKeys.PROPERTY_IMPORT_BULK_SET: "Set",
        TranslationKeys.PROPERTY_IMPORT_BULK_SKIPPED: "{count} properties do not allow this action and kept their previous choice.",
        TranslationKeys.PROPERTY_TOOLTIP_PENDING: "No check result yet. Press \"Run check\".",
        TranslationKeys.PROPERTY_TOOLTIP_BACKEND_OK: "The backend record exists and its data matches the import.",
        TranslationKeys.PROPERTY_TOOLTIP_BACKEND_ISSUES: "Backend: {causes}",
        TranslationKeys.PROPERTY_TOOLTIP_MAIN_OK: "The property is on the main map layer and its date is not older than the import.",
        TranslationKeys.PROPERTY_TOOLTIP_MAIN_ISSUES: "On the map: {causes}",
        TranslationKeys.PROPERTY_TOOLTIP_ARCHIVE_NONE: "Archiving only concerns properties that are no longer in the import. There is no plan for this row.",
        ...
        TranslationKeys.PROPERTY_ADD_STAGE_UPDATE: "Updating property data",
        TranslationKeys.PROPERTY_ADD_STAGE_USES: "Saving intended uses",
        TranslationKeys.PROPERTY_ADD_CANCELLED_RESULT: "Cancelled. Processed {done}/{total}. Succeeded: {succeeded}. Failed: {failed}. Not processed: {pending}.",
        TranslationKeys.PROPERTY_ADD_LOOKUP_FAILED: "Backend existence check failed. No record was created.",
        TranslationKeys.PROPERTY_ADD_WRITE_FAILED: "Backend save did not fully succeed. Check the record again before retrying.",
        TranslationKeys.PROPERTY_ADD_AMBIGUOUS: "An archived record or multiple active matches were found. Separate review is required; no automatic changes were made.",
        TranslationKeys.PROPERTY_ADD_MAP_FAILED: "The backend operation completed, but adding to the main layer failed or the layer is being edited.",
        TranslationKeys.PROPERTY_ADD_LAYER_CHANGED: "The import or main layer changed or is unavailable. Check the property again.",
        ...
        TranslationKeys.PROPERTY_GENERATE_SEARCH_FIELD: "Create/refresh search field",
        TranslationKeys.PROPERTY_SEARCH_FIELD_MISSING_BODY: "The selected main property layer does not contain the search_field field. Property search and automatic map zoom may not work without it.\n\nOpen Property management and run 'Create/refresh search field'.",
        TranslationKeys.PROPERTY_SEARCH_FIELD_MISSING_TOOLTIP: "search_field is missing. Create it for property search and zoom.",
        TranslationKeys.PROPERTY_SEARCH_FIELD_EXISTS_TOOLTIP: "search_field exists. You can refresh its values if needed.",
        TranslationKeys.PROPERTY_SEARCH_FIELD_PROGRESS_TITLE: "Property search field",
        TranslationKeys.PROPERTY_SEARCH_FIELD_PROGRESS_LABEL: "Building property search field...",
        TranslationKeys.PROPERTY_SEARCH_FIELD_CREATED_BODY: "Property search field is ready. Updated features: {count}.",
        TranslationKeys.PROPERTY_SEARCH_FIELD_FAILED_BODY: "Could not create the property search field.\n\nDetails: {error}",
        ...
        TranslationKeys.ADD_UPDATE_PROGRESS_COUNTS: "Processed {done}/{total} properties · Remaining {remaining}",
        TranslationKeys.ADD_UPDATE_PROGRESS_ELAPSED: "Elapsed {duration}",
        TranslationKeys.ADD_UPDATE_PROGRESS_ESTIMATING: "Calculating remaining time…",
        TranslationKeys.ADD_UPDATE_PROGRESS_ESTIMATE: "Approximately {duration} remaining",
        TranslationKeys.ADD_UPDATE_PROGRESS_CURRENT: "Property {tunnus}: save in progress.",
        TranslationKeys.ADD_UPDATE_PROGRESS_CANCELLED_TEMPLATE: "{prefix} - cancelled at {done}/{total}",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_TITLE: "Review archive plan",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_SCOPE: "Scope: {county} / {municipality} / {settlements}",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_INTRO: "{count} properties are missing from the complete import for the selected settlements. Review the planned map and backend actions before continuing.",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_COLUMN_TUNNUS: "Cadastral number",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_COLUMN_SETTLEMENT: "Settlement",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_COLUMN_MAP: "Map",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_COLUMN_BACKEND: "Backend",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_COLUMN_NOTE: "Note",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_MAP_MOVE: "Move to archive",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_BACKEND_ARCHIVE: "Archive",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_BACKEND_MISSING: "No active record — skip",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_BACKEND_FAILED: "Check failed — skip",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_BACKEND_MULTIPLE: "Multiple active records — skip",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_CONFIRM: "Confirm and continue",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_CANCEL: "Cancel",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_COMPLETENESS_CONFIRM: "I confirm that the import contains the complete current data for the selected settlements.",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_STALE_TITLE: "Archive plan is no longer current",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_STALE_BODY: "The selected area or import layer changed after the checks. Run the checks again before applying changes.",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_PARTIAL_TITLE: "Archive completed with issues",
        TranslationKeys.PROPERTY_ARCHIVE_PLAN_PARTIAL_BODY: "Map archived: {moved}. Backend archived: {archived}. Failed or skipped operations: {failed}.",
        TranslationKeys.PROPERTY_ARCHIVE_SCOPE_SKIPPED: "Missing-property archiving is disabled for this run. Select at least one settlement and load its complete, non-empty import data.",
        TranslationKeys.PROPERTY_ARCHIVE_MOVED_EXCLUDED: "{count} missing cadastral numbers were found elsewhere in the import and excluded from automatic archiving.",
    ...
    TranslationKeys.LOGIN_USERNAME_REQUIRED: "Please enter your username.",
    TranslationKeys.LOGIN_PASSWORD_REQUIRED: "Please enter your password.",
    TranslationKeys.LOGIN_USERNAME_INVALID: "Check your username.",
    TranslationKeys.LOGIN_PASSWORD_INVALID: "Check your password.",
    TranslationKeys.LOGIN_CREDENTIALS_INVALID: "Username or password does not match.",
    TranslationKeys.LOGIN_SERVER_UNAVAILABLE: "Login failed. Please try again.",
    TranslationKeys.LOGIN_TOO_MANY_ATTEMPTS: "Too many login attempts. Wait a minute and try again.",
    TranslationKeys.MFA_CODE_PROMPT: "Enter the 6-digit code from your authenticator app, or one of your recovery codes.",
    TranslationKeys.MFA_CODE_REQUIRED: "Enter the code.",
    TranslationKeys.MFA_CODE_FORMAT: "The code is 6 digits. A recovery code is 8 letters and digits.",
    TranslationKeys.MFA_CODE_INVALID: "The code is wrong or has expired. Try again.",
    TranslationKeys.MFA_VERIFY_BUTTON: "Verify",
    TranslationKeys.MFA_BACK_BUTTON: "Back",
    TranslationKeys.MFA_SETUP_REQUIRED: "Your organisation requires two-factor authentication. Turn it on in the Kavitro web app, then try again.",
    TranslationKeys.MFA_OPEN_WEB_APP: "Open Kavitro web app",
    TranslationKeys.SESSION_STORAGE_WARNING_TITLE: "Session was not fully saved",
    TranslationKeys.SESSION_STORAGE_MEMORY_ONLY: "QGIS secure session storage could not be opened. You can continue working during this QGIS run, but you must sign in again after closing QGIS. Neither the Kavitro password nor the access token was stored in plaintext.",
    TranslationKeys.SESSION_STORAGE_MIGRATION_PENDING: "The session was restored, but the legacy authentication entry could not be cleaned completely. You can continue working and cleanup will be retried on a later suitable startup or sign-in.",
    TranslationKeys.SESSION_STORAGE_CLEANUP_FAILED: "Removal of the legacy plaintext access token from QGIS settings could not be verified. Finish work securely and contact support; do not share the QGIS profile or its backup.",
    ...
    TranslationKeys.PROPERTY_BOOTSTRAP_REQUIRED_TITLE: "Property main layer is missing",
    TranslationKeys.PROPERTY_BOOTSTRAP_REQUIRED_BODY: "No property main layer is configured in the project. Create a new GeoPackage with empty main and archive layers based on the selected SHP structure?",
    TranslationKeys.PROPERTY_BOOTSTRAP_CREATE: "Create GeoPackage layers",
    TranslationKeys.PROPERTY_BOOTSTRAP_CONTINUE_SHP: "Continue with SHP only",
    TranslationKeys.PROPERTY_BOOTSTRAP_EXISTING_GPKG_TITLE: "GeoPackage already exists",
    TranslationKeys.PROPERTY_BOOTSTRAP_EXISTING_GPKG_BODY: "The file already exists:\n{path}\n\nAdd the property main and archive layers to this file? Existing layers will not be overwritten.",
    TranslationKeys.PROPERTY_BOOTSTRAP_ADD_TO_GPKG: "Add layers",
    TranslationKeys.PROPERTY_BOOTSTRAP_SAVE_DIALOG_TITLE: "Choose property GeoPackage location",
    TranslationKeys.PROPERTY_BOOTSTRAP_FAILED_TITLE: "Property layer creation failed",
    TranslationKeys.PROPERTY_BOOTSTRAP_MISSING_FIELDS_BODY: "The SHP structure is missing required property fields:\n{fields}\n\nNo GeoPackage layers were created.",
    TranslationKeys.PROPERTY_BOOTSTRAP_INVALID_GEOMETRY_BODY: "The SHP must be a polygon layer to create the property main layer. No GeoPackage layers were created.",
    TranslationKeys.PROPERTY_BOOTSTRAP_INVALID_CRS_BODY: "The SHP layer has no valid coordinate reference system. No GeoPackage layers were created.",
    TranslationKeys.PROPERTY_BOOTSTRAP_LAYER_EXISTS_BODY: "A layer named '{name}' already exists in the project or selected GeoPackage. No layer was overwritten; choose another GeoPackage.",
    TranslationKeys.PROPERTY_BOOTSTRAP_INVALID_SOURCE_BODY: "The selected SHP layer is invalid and cannot be used to create property layers.",
    TranslationKeys.PROPERTY_BOOTSTRAP_CREATE_FAILED_BODY: "Creating the property main and archive layers failed during: {stage}. Details were saved to the log.",
    TranslationKeys.PROPERTY_BOOTSTRAP_STAGE_CREATE_MAIN: "main layer creation",
    TranslationKeys.PROPERTY_BOOTSTRAP_STAGE_LOAD_MAIN: "main layer loading",
    TranslationKeys.PROPERTY_BOOTSTRAP_STAGE_CREATE_ARCHIVE: "archive layer creation",
    TranslationKeys.PROPERTY_BOOTSTRAP_STAGE_SAVE_SETTINGS: "layer settings persistence",
    TranslationKeys.PROPERTY_BOOTSTRAP_READY_BODY: "Created and configured main layer '{main}' and archive layer '{archive}' in:\n{path}",
    ...
    ,TranslationKeys.PROPERTY_COLUMN_BACKEND: "Backend"
    ,TranslationKeys.PROPERTY_COLUMN_MAIN_LAYER: "Main layer"
    ,TranslationKeys.PROPERTY_COLUMN_ARCHIVE_BACKEND: "Archive: backend"
    ,TranslationKeys.PROPERTY_COLUMN_ARCHIVE_MAP: "Archive: map"
    ...
    ,TranslationKeys.SELECT_SINGLE_PROPERTY_MESSAGE: "Please select only one property feature on the map."
        ...
        ,TranslationKeys.WORKS_CREATE_STATUS_LABEL: "Status"
        ...
        ,TranslationKeys.WORKS_PENDING_GIS_ACTION: "Check unlinked GIS works"
        ,TranslationKeys.WORKS_PENDING_GIS_START_FAILED: "Could not start the unlinked GIS works check."
        ,TranslationKeys.WORKS_PENDING_GIS_CHECKING: "Checking map data..."
        ,TranslationKeys.WORKS_PENDING_GIS_DIALOG_TITLE: "Unlinked GIS works"
        ,TranslationKeys.WORKS_PENDING_GIS_DIALOG_INTRO: "These Works layer points are not linked to a Kavitro work item yet. Double-click a row to zoom to it and review a prefilled work creation form."
        ,TranslationKeys.WORKS_PENDING_GIS_NONE: "No new unlinked GIS works were found on the Works layer."
        ,TranslationKeys.WORKS_PENDING_GIS_OPEN_SELECTED: "Open selected"
        ,TranslationKeys.WORKS_PENDING_GIS_COL_ID: "FID"
        ,TranslationKeys.WORKS_PENDING_GIS_COL_TITLE: "Title"
        ,TranslationKeys.WORKS_PENDING_GIS_COL_TYPE: "Type"
        ,TranslationKeys.WORKS_PENDING_GIS_COL_STATUS: "Status"
        ,TranslationKeys.WORKS_PENDING_GIS_COL_UPDATED: "Updated"
        ,TranslationKeys.WORKS_PENDING_GIS_FEATURE_MISSING: "The selected GIS work was not found on the layer anymore or is already linked to Kavitro."
