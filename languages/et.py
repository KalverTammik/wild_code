...
TRANSLATIONS = {
    ...
    ,TranslationKeys.LINK_PROPERTIES_ERROR: "Kinnistute seostamine projektile {pid} ebaõnnestus.\nOotel valik ({count}): {preview}\n\nDetailid: {err}"
        ...
        ,TranslationKeys.WORKS_CREATE_ON_MAP_BUTTON: "Loo kaardile"
        ...
        ,TranslationKeys.WORKS_CREATE_VALIDATE_TYPE: "Palun vali töö liik."
        ,TranslationKeys.WORKS_CREATE_VALIDATE_TITLE: "Palun sisesta töö pealkiri."
        ...
        ,TranslationKeys.WORKS_LAYER_ID_FIELD_MISSING: "Seadistatud Tööde kihil puudub ülesande id väli (`Mailabl_id` või `task_id`)."
        ...
        ,TranslationKeys.WORKS_REPOSITION_SUCCESS: "Töö {task_id} paigutati edukalt ümber."
        ...
        ,TranslationKeys.WORKS_TEMP_LAYER_HELPER_DESCRIPTION: "Ajutine arendusabiline. Loob või laeb punktipõhise Tööde kihi samasse GeoPackage'i, kus asub valitud Tööde viitekiht, või kasutab varuna seadistatud Kinnistute põhikihti. Loodud kiht määratakse kohe aktiivseks Tööde põhikihiks."
        ...
        ,TranslationKeys.WORKS_TEMP_LAYER_REFERENCE_REQUIRED: "Vali kõigepealt Tööde viitekiht või seadista Kinnistute põhikiht. Abiline vajab olemasolevat kihti, et määrata kasutatav GeoPackage ja CRS."
        ,TranslationKeys.WORKS_TEMP_LAYER_GPKG_REQUIRED: "Ajutist Tööde kihti saab luua ainult GeoPackage-põhise viitekihi järgi. Vali Tööde kihi valikust GPKG kiht või seadista Seadetes Kinnistute põhikiht."
