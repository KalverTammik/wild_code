...
class PopupHelpers:
    ...
    def _profile(popup_kind: str | None):
        ...
        overrides = PopupHelpers.POPUP_PROFILES.get(key, {})
        return {**PopupHelpers.DEFAULT_POPUP_PROFILE, **overrides}

    @staticmethod
    def popup_delay(popup_kind: str | None = None) -> int:
        return int(PopupHelpers._profile(popup_kind)["delay_ms"])

    @staticmethod
    def popup_close_on_deactivate(popup_kind: str | None = None) -> bool:
        return bool(PopupHelpers._profile(popup_kind)["close_on_deactivate"])
    ...
    def handle_hide_timeout(timer, anchor_widget, popup_widget, hide_callback, delay_ms: int = 120) -> None:
        try:
            ...
            PythonFailLogger.log_exception(
                exc,
                module="ui",
                event=PopupHelpers.EVENT_HIDE_TIMEOUT_FAILED,
            )
    ...
    def bind_hide_timeout_attr_for(
        ...
        *,
        ...
        PopupHelpers.bind_hide_timeout(
            timer,
            ...
            delay_ms=PopupHelpers.popup_delay(popup_kind),
        )
        ...
        *,
        ...
        try:
            ...
            PythonFailLogger.log_exception(
                exc,
                module="ui",
                event=PopupHelpers.EVENT_HOVER_EVENT_FAILED,
            )
            return False
        ...
        *,
        ...
        try:
            ...
            PythonFailLogger.log_exception(
                exc,
                module="ui",
                event=PopupHelpers.EVENT_SHOW_POPUP_FAILED,
            )
            return None
    ...
    def show_popup_for(
        ...
        *,
        ...
        return PopupHelpers.show_popup(
            timer=timer,
            ...
            offset=QPoint(*profile["offset"]),
            keep_on_screen=bool(profile["keep_on_screen"]),
            smart_flip=bool(profile["smart_flip"]),
            screen_padding=int(profile["screen_padding"]),
        )
    ...
    def apply_popup_style(widget, popup_kind: str | None = None) -> None:
        ...
        try:
            ...
            style_key = PopupHelpers._profile(popup_kind)["style_key"]
            ...
            PythonFailLogger.log_exception(
                exc,
                module="ui",
                event=PopupHelpers.EVENT_STYLE_APPLY_FAILED,
            )
