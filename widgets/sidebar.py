...
class Sidebar(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        try:
            ...
            pass
        # Ainult Avalehe nupu ikooni mõõt (20x20)
        try:
        ...
        try:
            self.settingsButton.setIconSize(QSize(20, 20))  # Ühtlustatud ikooni suurus
        except Exception:
            pass
    ...
    def addItem(self, displayName, uniqueIdentifier, iconPath=None):
        ...
        # Projekte nupp ikooni ühtlustatud suurus 20x20
        if uniqueIdentifier in ('ProjectsModule', 'ContractModule', 'PropertyModule'):
            try:
                btn.setIconSize(QSize(20, 20))  # Ühtlustatud ikooni suurus
            except Exception:
                pass
    ...
    def retheme_sidebar(self):
        ...
        for uniqueIdentifier, btn in self.moduleButtons.items():
            ...
            if uniqueIdentifier in ('ProjectsModule', 'ContractModule', '__HOME__', 'PropertyModule'):
                try:
                    btn.setIconSize(QSize(20, 20))  # Tagame ühtluse ka teema vahetusel
                except Exception:
                    pass
